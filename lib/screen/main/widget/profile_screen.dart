                          ...
                          children: [
                            ...
                            (membership != null)? 
                              Column(
                                children: [
                                  const SizedBox(height: 6,),
                                  Text('Anggota sejak 11/2022', style: kBody2.apply(color: Colors.white),)
                                ],
                              ) : const SizedBox()
                          ],
                        )
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Image(image: AssetImage('assets/profile_page/history1.png'), height: 30, width: 30,),
                      const SizedBox(height: 6,),
                      Text('Riwayat Aktivitas', style: kBody2,)
                    ],
                  ),
                ),
                Expanded(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Image(image: AssetImage('assets/profile_page/history2.png'), height: 30, width: 30,),
                      const SizedBox(height: 6,),
                      Text('Riwayat Pemesanan', style: kBody2,)
                    ],
                  ),
                )
              ],
    ...
    child: Column(
      children: [
        ...
        Align(
          ...
          child: Text('Membership', style: kSubtitle1,)
        ),
  ...
  return Container(
    ...
    child: Column(
      children: [
        Align(
          alignment: Alignment.centerLeft,
          child: Text('Akun Saya', style: kSubtitle1,),
        ),
        const SizedBox(height: 32,),
        _profileItemButton(icon: SvgPicture.asset('assets/profile_page/note_pencil.svg'), title: 'Edit Profile'),
        _profileItemButton(icon: SvgPicture.asset('assets/profile_page/lock_password.svg'), title: 'Ganti Password'),
        _profileItemButton(icon: SvgPicture.asset('assets/profile_page/user_block.svg'), title: 'Cuti/Freeze Membership'),
        _profileItemButton(icon: SvgPicture.asset('assets/profile_page/delete_dismiss.svg'), title: 'Hapus Akun'),
        const SizedBox(height: 48,),
      ],
    ),
  );
  ...
  return Container(
    ...
    child: Column(
      children: [
        Align(
          alignment: Alignment.centerLeft,
          child: Text('Tentang', style: kSubtitle1,),
        ),
        const SizedBox(height: 32,),
        _profileItemButton(icon: SvgPicture.asset('assets/profile_page/note_text.svg'), title: 'Syarat & Ketentuan'),
        _profileItemButton(icon: Icon(Icons.privacy_tip_outlined, color: primaryBase,), title: 'Kebijakan Privasi'),
        _profileItemButton(icon: SvgPicture.asset('assets/profile_page/star_settings.svg'), title: 'Beri Kami Penilaian'),
        _profileItemButton(
              ...
              builder: (context) => AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    Text('Keluar', style: kSubtitle1,),
                    const SizedBox(height: 12,),
                    Text('Kamu yakin ingin keluar?' ,style: kBody1.apply(color: const Color(0xFF9F9696)),),
                    const SizedBox(height: 12,),
                  ],
                ),
                actions: [
    ...
    child: ElevatedButton(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(title, style: kBody2.apply(color: blackLighter),)
          ),
          Icon(Icons.navigate_next, color: primaryBase,)
        ],
      ),
