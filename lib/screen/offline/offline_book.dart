                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              widget.model.offlineClassCategory!.name!,
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  Utils.dateTimeFormat(widget.model.time),
                                  style: kSubtitle2.copyWith(color: blackBase),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                Text(
                                  Utils.currencyFormat(widget.model.price!),
                                  style: GoogleFonts.roboto(
                                    fontSize: 16,
                                    fontWeight: bold,
                                    letterSpacing: 0.15,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.model.offlineClassCategory!.description!,
                        ...
                        Row(
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                widget.model.offlineClassCategory!.picture!,
                                width: 69,
                                height: 67,
                                fit: BoxFit.cover,
                              ),
